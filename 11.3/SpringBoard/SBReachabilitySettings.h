...
@interface SBReachabilitySettings : SBUISettings
{
    ...
    double _swipeDownHysteresis;
    double _swipeDownHeight;
    double _mass;
    double _stiffness;
    double _damping;
    double _epsilon;
...
@property(nonatomic) double swipeDownHeight; // @synthesize swipeDownHeight=_swipeDownHeight;
@property(nonatomic) double swipeDownHysteresis; // @synthesize swipeDownHysteresis=_swipeDownHysteresis;
