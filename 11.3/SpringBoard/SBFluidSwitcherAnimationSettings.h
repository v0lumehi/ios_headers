...
@interface SBFluidSwitcherAnimationSettings : SBUISettings
{
    ...
    SBFluidBehaviorSettings *_gestureInitiatedGridHomeToSwitcherSettings;
    ...
    SBFluidBehaviorSettings *_reachabilitySettings;
    ...
    SBFluidBehaviorSettings *_gridSwipeUpOpacitySettings;
    ...
    double _homeToSwitcherScaledOutCardsBottomMarginFromDock;
    double _homeToSwitcherCardOpacityCurveExponent;
...
@property(nonatomic) double homeToSwitcherCardOpacityCurveExponent; // @synthesize homeToSwitcherCardOpacityCurveExponent=_homeToSwitcherCardOpacityCurveExponent;
@property(nonatomic) double homeToSwitcherScaledOutCardsBottomMarginFromDock; // @synthesize homeToSwitcherScaledOutCardsBottomMarginFromDock=_homeToSwitcherScaledOutCardsBottomMarginFromDock;
...
@property(retain, nonatomic) SBFluidBehaviorSettings *gridSwipeUpOpacitySettings; // @synthesize gridSwipeUpOpacitySettings=_gridSwipeUpOpacitySettings;
...
@property(retain, nonatomic) SBFluidBehaviorSettings *reachabilitySettings; // @synthesize reachabilitySettings=_reachabilitySettings;
...
@property(retain, nonatomic) SBFluidBehaviorSettings *gestureInitiatedGridHomeToSwitcherSettings; // @synthesize gestureInitiatedGridHomeToSwitcherSettings=_gestureInitiatedGridHomeToSwitcherSettings;
